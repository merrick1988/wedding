            ...
            <section id="hotel">
                <div className="container">
                    ...
                    <p>
                        ...
                        праздничный день, но также и хороошенько отдохнуть после длительных переездов, даже есди вы
                        будете
                        ехать с Киева, 20 минут не шутка :) В комнатах будет все необходимое чтоб отдохнуть и
                        собраться к
                        торжеству.
                    </p>
